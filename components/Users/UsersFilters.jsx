      ...
      <div className="flex flex-wrap gap-4 items-end">
        ...
        <form onSubmit={handleSearch} className="flex-1 min-w-[200px]">
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-gray-700 border border-gray-600 rounded-lg pl-10 pr-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:border-green-primary"
            />
        ...
        <div className="min-w-[150px]">
          ...
          <select
            ...
            className="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-green-primary"
          >
