    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-4 items-center">
        ...
        <select
          ...
          className="bg-gray-800 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-green-primary"
        >
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-700">
                ...
                <th className="text-left px-6 py-4 text-sm font-medium text-gray-400">Device</th>
                <th className="text-left px-6 py-4 text-sm font-medium text-gray-400">App Version</th>
                  ...
                  return (
                    <tr key={device.id} className="border-b border-gray-700/50 hover:bg-gray-700/30">
                      <td className="px-6 py-4">
                        <div>
                          <p className="text-white font-medium">{device.user?.email || "Unknown"}</p>
