...
function AnswerBox({ chat }) {
  return (
    <div className="bg-[#10131D] w-[702px] h-[500px] rounded-3xl flex flex-col overflow-hidden ">
      <div className="px-11 pt-14 overflow-x-scroll space-y-8 flex-1">
    ...
    <div className="bg-dashboard-box  dark:bg-[#0F1017] p-4">
      <div className="flex items-center justify-between bg-[#10131D] py-4 px-2.5 gap-4 rounded-xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button className="bg-green-primary cursor-pointer size-9 rounded-full flex justify-center items-center ">
            <Send />
          </Button>
        </div>
      </div>
