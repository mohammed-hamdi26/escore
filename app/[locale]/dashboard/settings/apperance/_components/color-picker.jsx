...
export const ColorPickerSelection = memo(({
  ...
  const { hue, setSaturation, setLightness, setSelectedColor, saturation,lightness,alpha } = useColorPicker();
  ...
  return (
    <div
      ...
      onPointerUp={(e) => {
        e.preventDefault();
        setSelectedColor(Color.hsl(hue, saturation, lightness, alpha / 100).hex())
      }}
      ref={containerRef}
      style={{
...
export const ColorPickerHue = ({
  ...
  const { hue, setHue,setSelectedColor,saturation,lightness,alpha } = useColorPicker();
